...
function AddNewInterview() {
    ...
    const onSubmit=async(e)=>{
      ...
      const InputPrompt="Job Position:"+jobPosition+", Job Description:"+jobDesc+", Years of Experience:"+jobExperience+", depend on this information please give me "+process.env.NEXT_PUBLIC_INTERVIEW_QUESTION_COUNT+" interview question with answers in json format. give questions and answers as field in json";
